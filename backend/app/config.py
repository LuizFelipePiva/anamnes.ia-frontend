...
# Resumo semanal por IA (SPEC-013 §6.9, D4). Desligado por padrão: enquanto for
# `false`, a rota responde 404 e nenhum token é gasto. A flag existe no backend
# **além** da do front porque a do front só evita a chamada — esta evita o custo
# mesmo que alguém bata no endpoint direto.
